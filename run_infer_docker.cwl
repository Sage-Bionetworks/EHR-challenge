        ...
        entry: |
          ...
          def main(args):
            ...
            if container is None:
              ...
              try:
                container = client.containers.run(docker_image, 'bash "/app/infer.sh"', detach=True, volumes = volumes, name=args.submissionid, network_disabled=True, mem_limit='200g', stderr=True)
